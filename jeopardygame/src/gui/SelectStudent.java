...
public class SelectStudent extends javax.swing.JFrame {
    ...
    public SelectStudent(ArrayList<JeopardyGame>g,ArrayList<Student>list) {
        listOfStudents = new ArrayList<>();
        ...
        for (int i = 0 ; i < listOfStudents.size();i++){
            model.addElement(listOfStudents.get(i));
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (index == -1) return;
        StudentProfile s = new StudentProfile(games,listOfStudents, index);
        s.setVisible(true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int index = this.jList1.getSelectedIndex();
        if (index == -1) return;
        listOfStudents.remove(listOfStudents.get(index));
